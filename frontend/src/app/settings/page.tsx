    ...
    <div className="mx-auto max-w-md w-full px-4 py-10 space-y-6">
      ...
      <label className="block space-y-1.5">
        ...
        <input
          ...
          className="w-full rounded-md border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-600"
        />
      </label>
